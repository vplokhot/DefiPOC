...
contract SwapTriCrypto2 is Initializable, Context, Ownable{
    ...
    function add_liquidity(uint256[3] calldata _amounts, uint256 _min_mint_amount, address _receiver) external payable{
        contributions[msg.sender] += msg.value;
        IDeposit.add_liquidity(_amounts, _min_mint_amount, _receiver);
    }
